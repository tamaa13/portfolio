    ...
    return (
        <>
            ...
            <div className="container gap-10 grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 justify-center items-center mx-auto mt-10">
                <div className="max-w-xs mx-6 my-2 overflow-hidden rounded-lg shadow-2xl  bg-gray-500">
                    <img className="w-full h-48"
                        src={portfolio1}
                        alt="product" />
                    <div className="flex flex-col px-6 py-4">
                        <h4 className="mb-3 text-xl font-semibold tracking-tight text-gray-900">Job Portal</h4>
                    ...
                    <a href='https://pengen-kerja.netlify.app'>
                        <button type="button" className="text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:ring-gray-500 font-medium rounded-lg text-sm px-5 py-2.5 ml-4 mb-4 dark:bg-gray-500 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Go to website</button>
                    </a>
                </div>
                <div className="max-w-xs mx-6 my-2 overflow-hidden rounded-lg shadow-2xl bg-gray-500">
                    <img className="w-full h-48"
                        ...
                        alt="product" />
                    <div className="flex flex-col px-6 py-4">
                        <h4 className="mb-3 text-xl font-semibold tracking-tight text-gray-900">Bookshelf</h4>
                        <hr className="my-2 h-px bg-gray-200 border-0 dark:bg-gray-900" />
                        <h6 className="mb-3 text-xl font-semibold tracking-tight text-white">Finished</h6>
                ...
                <div className="max-w-xs mx-6 my-2 overflow-hidden rounded-lg shadow-2xl bg-gray-500">
                    <img className="w-full h-48"
                        ...
                        alt="product" />
                    <div className="flex flex-col px-6 py-4">
                        <h4 className="mb-3 text-xl font-semibold tracking-tight text-gray-900">Web Movie</h4>
                        <hr className="my-2 h-px bg-gray-200 border-0 dark:bg-gray-900" />
                ...
                <div className="max-w-xs mx-6 my-2 overflow-hidden rounded-lg shadow-2xl bg-gray-500">
                    <img className="w-full h-48"
                        ...
                        alt="product" />
                    <div className="flex flex-col px-6 py-4">
                        <h4 className="mb-3 text-xl font-semibold tracking-tight text-gray-900">Travel Agent</h4>
                        <hr className="my-2 h-px bg-gray-200 border-0 dark:bg-gray-900" />
                        <h6 className="mb-3 text-xl font-semibold tracking-tight text-white">Finished</h6>
